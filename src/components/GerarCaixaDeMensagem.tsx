...
export default function GerarCaixaDeMensagem({ mensagem, visible, funcaoSim, funcaoNao }: GerarCaixaDeMensagem) {
    return (
        <div className={`bg-red-400 w-[95%] max-w-[400px] p-4 absolute top-[50%] left-[50%] z-40 ${visible ? 'block' : 'hidden'}`} style={{ transform: 'translate(-50%)', boxShadow: '0px 0px 2px 2px black' }}>
